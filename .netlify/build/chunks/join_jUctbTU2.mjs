...
We sent a 6-digit code to <strong id="email-display" style="color:var(--text);" data-astro-cid-jtzn4zcc></strong> </p> <div class="otp-row" data-astro-cid-jtzn4zcc> <input class="otp-input" type="text" maxlength="1" inputmode="numeric" id="otp-0" oninput="otpInput(this,0)" onkeydown="otpKeydown(event,0)" data-astro-cid-jtzn4zcc> <input class="otp-input" type="text" maxlength="1" inputmode="numeric" id="otp-1" oninput="otpInput(this,1)" onkeydown="otpKeydown(event,1)" data-astro-cid-jtzn4zcc> <input class="otp-input" type="text" maxlength="1" inputmode="numeric" id="otp-2" oninput="otpInput(this,2)" onkeydown="otpKeydown(event,2)" data-astro-cid-jtzn4zcc> <input class="otp-input" type="text" maxlength="1" inputmode="numeric" id="otp-3" oninput="otpInput(this,3)" onkeydown="otpKeydown(event,3)" data-astro-cid-jtzn4zcc> <input class="otp-input" type="text" maxlength="1" inputmode="numeric" id="otp-4" oninput="otpInput(this,4)" onkeydown="otpKeydown(event,4)" data-astro-cid-jtzn4zcc> <input class="otp-input" type="text" maxlength="1" inputmode="numeric" id="otp-5" oninput="otpInput(this,5)" onkeydown="otpKeydown(event,5)" data-astro-cid-jtzn4zcc> </div> <div class="field-error hidden" id="s2-error" style="text-align:center;margin-bottom:12px;" data-astro-cid-jtzn4zcc></div> <!-- Consent checkbox — required before account creation (GDPR / CCPA / PDPL) --> <label id="consent-label" style="display:flex;align-items:flex-start;gap:10px;margin-bottom:16px;cursor:pointer;font-size:13px;color:var(--text-muted);line-height:1.5;" data-astro-cid-jtzn4zcc> <input type="checkbox" id="consent-checkbox" style="margin-top:2px;accent-color:var(--brand);width:16px;height:16px;flex-shrink:0;" data-astro-cid-jtzn4zcc> <span data-astro-cid-jtzn4zcc>I agree to the <a href="/terms" target="_blank" style="color:var(--brand);text-decoration:underline;" data-astro-cid-jtzn4zcc>Terms of Service</a> and <a href="/privacy" target="_blank" style="color:var(--brand);text-decoration:underline;" data-astro-cid-jtzn4zcc>Privacy Policy</a>. I confirm my certification details are genuine and accurate.</span> </label> <button class="btn-primary" id="verify-btn" onclick="verifyAndCreate()" data-astro-cid-jtzn4zcc>
Verify &amp; Go Live 🚀
...
<\/script> `])), maybeRenderHead(), market.certificationBody, market.phonePrefix, market.certificationBody, market.certVerifyLabel, market.certificationBody) })}`;
}, "/home/ubuntu/trainedby2/src/pages/join.astro", void 0);

const $$file = "/home/ubuntu/trainedby2/src/pages/join.astro";
const $$url = "/join";
