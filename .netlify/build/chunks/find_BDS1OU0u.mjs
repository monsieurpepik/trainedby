...
import { h as renderComponent, r as renderTemplate, k as Fragment, l as defineScriptVars, m as maybeRenderHead } from './ssr-function_BCqmIxwe.mjs';
...
loadTrainers();
    ...
    </div>`).join(""), defineScriptVars({ SUPABASE_KEY })), "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": async ($$result3) => renderTemplate` <meta name="color-scheme" content="light"> <meta name="theme-color" content="#FFFFFF"> <link href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,400;0,9..40,500;0,9..40,700;0,9..40,800;1,9..40,400&display=swap" rel="stylesheet">  ` })}` })}`;
