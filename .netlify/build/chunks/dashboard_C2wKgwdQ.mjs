...
import { r as renderTemplate, j as defineScriptVars, m as maybeRenderHead, f as addAttribute, h as renderComponent, k as Fragment } from './ssr-function_BO-eb4Zn.mjs';
...
function populateDash(t) {
  ...
  const waMsg = encodeURIComponent('Hey! I\\'m using TrainedBy to manage my PT business and earn passive income from affiliates. Get your free profile here: ' + refUrl);
...
function generateInsight(data) {
  ...
  if (views > 20 && leads === 0) {
    ...
    action = \`<a href="/edit.html" style="font-size:12px;font-weight:700;color:var(--brand);text-decoration:none;">→ Add a Grand Slam Offer with a guarantee to convert views into bookings</a>\`;
    ...
    action = \`<a href="/edit.html" style="font-size:12px;font-weight:700;color:var(--brand);text-decoration:none;">→ Make sure your WhatsApp number is visible on your profile</a>\`;
    ...
    action = convRate < 5 ? \`<a href="/edit.html" style="font-size:12px;font-weight:700;color:var(--brand);text-decoration:none;">→ Add a money-back guarantee to your packages</a>\` : '';
  } else if (views === 0) {
...
async function loadLeads() {
  try {
    ...
    data.forEach(lead => {
      ...
      const waMsg = encodeURIComponent(\`Hi \${lead.name}, I'm \${trainer.name} from TrainedBy.ae. I saw your enquiry and would love to help you reach your fitness goals!\`);
...
(function() {
  ...
  win.innerHTML = '<div class="tb-chat-header"><div><div class="tb-chat-header-title">TrainedBy Support</div><div class="tb-chat-header-sub">Ask me anything about your account</div></div><button class="tb-chat-close" id="tb-close"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg></button></div><div class="tb-chat-messages" id="tb-msgs"><div class="tb-msg bot">Hey! Ask me anything about TrainedBy — pricing, REPs verification, referrals, or how features work.</div></div><div class="tb-chat-input-row"><input class="tb-chat-input" id="tb-input" placeholder="Ask a question..." maxlength="300"/><button class="tb-chat-send" id="tb-send"><svg viewBox="0 0 24 24"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg></button></div>';
...
})();</script> `])), maybeRenderHead(), renderComponent($$result2, "ProfileCompleteness", $$ProfileCompleteness, { "data-astro-cid-3nssi2tu": true }), defineScriptVars({ SUPABASE_ANON_KEY, ANON_KEY })), "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": async ($$result3) => renderTemplate` <meta name="color-scheme" content="light"> <meta name="theme-color" content="#FFFFFF"> <meta name="apple-mobile-web-app-status-bar-style" content="default"> <link href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,400;0,9..40,500;0,9..40,700;0,9..40,800;1,9..40,400&display=swap" rel="stylesheet"> ` })}` })}`;
