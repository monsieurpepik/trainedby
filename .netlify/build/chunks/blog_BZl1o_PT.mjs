...
const $$Blog = createComponent(async ($$result, $$props, $$slots) => {
  const SUPABASE_KEY = "";
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": "TrainedBy Blog — Expert Fitness Advice from UAE's Top Trainers", "description": "Evidence-based fitness, nutrition, and training articles from UAE's REPs-verified personal trainers.", "data-astro-cid-ijnerlr2": true }, { "default": async ($$result2) => renderTemplate(_a || (_a = __template(["   ", `<nav class="nav" data-astro-cid-ijnerlr2> <div class="nav-inner" data-astro-cid-ijnerlr2> <a href="/landing.html" class="nav-logo" data-astro-cid-ijnerlr2> <svg width="28" height="28" viewBox="0 0 32 32" data-astro-cid-ijnerlr2><rect width="32" height="32" rx="8" fill="#FF5C00" data-astro-cid-ijnerlr2></rect><text x="16" y="23" font-family="Manrope,Arial,sans-serif" font-size="14" font-weight="800" text-anchor="middle" fill="white" data-astro-cid-ijnerlr2>TB</text></svg>
TrainedBy
</a> <div class="nav-links" data-astro-cid-ijnerlr2> <a href="/find.html" data-astro-cid-ijnerlr2>Find a Trainer</a> <a href="/blog.html" class="active" data-astro-cid-ijnerlr2>Blog</a> <a href="/join.html" class="nav-cta" data-astro-cid-ijnerlr2>Get Your Page</a> </div> </div> </nav>  <div class="blog-hero" data-astro-cid-ijnerlr2> <div class="blog-hero-eyebrow" data-astro-cid-ijnerlr2>Expert Knowledge</div> <h1 class="blog-hero-title" data-astro-cid-ijnerlr2>Fitness advice from<br data-astro-cid-ijnerlr2>trainers who actually train.</h1> <p class="blog-hero-sub" data-astro-cid-ijnerlr2>Every article on TrainedBy is written by a REPs UAE verified personal trainer. No generic content. No AI fluff. Real expertise, cited sources.</p> <div class="blog-hero-stats" data-astro-cid-ijnerlr2> <div class="blog-stat" data-astro-cid-ijnerlr2><strong id="article-count" data-astro-cid-ijnerlr2>—</strong> articles published</div> <div class="blog-stat" data-astro-cid-ijnerlr2><strong id="trainer-count" data-astro-cid-ijnerlr2>—</strong> verified trainers contributing</div> <div class="blog-stat" data-astro-cid-ijnerlr2><strong data-astro-cid-ijnerlr2>100%</strong> evidence-based</div> </div> </div>  <div class="filter-bar" id="filter-bar" data-astro-cid-ijnerlr2> <button class="filter-pill active" onclick="filterArticles('all', this)" data-astro-cid-ijnerlr2>All</button> <button class="filter-pill" onclick="filterArticles('nutrition', this)" data-astro-cid-ijnerlr2>Nutrition</button> <button class="filter-pill" onclick="filterArticles('training', this)" data-astro-cid-ijnerlr2>Training</button> <button class="filter-pill" onclick="filterArticles('fat-loss', this)" data-astro-cid-ijnerlr2>Fat Loss</button> <button class="filter-pill" onclick="filterArticles('muscle-gain', this)" data-astro-cid-ijnerlr2>Muscle Gain</button> <button class="filter-pill" onclick="filterArticles('recovery', this)" data-astro-cid-ijnerlr2>Recovery</button> <button class="filter-pill" onclick="filterArticles('mindset', this)" data-astro-cid-ijnerlr2>Mindset</button> <button class="filter-pill" onclick="filterArticles('uae-lifestyle', this)" data-astro-cid-ijnerlr2>UAE Lifestyle</button> </div>  <div class="blog-main" data-astro-cid-ijnerlr2> <div class="blog-content" data-astro-cid-ijnerlr2> <!-- Write for us banner --> <div class="write-banner" data-astro-cid-ijnerlr2> <div class="write-banner-title" data-astro-cid-ijnerlr2>Are you a REPs UAE verified trainer?</div> <div class="write-banner-sub" data-astro-cid-ijnerlr2>Publish an article on TrainedBy and get your profile in front of thousands of potential clients searching for expertise in your specialty.</div> <a href="/edit.html" class="write-banner-btn" data-astro-cid-ijnerlr2>Write for TrainedBy →</a> </div> <!-- Featured article --> <div id="featured-slot" data-astro-cid-ijnerlr2></div> <!-- Article grid --> <div id="article-grid" class="article-grid" data-astro-cid-ijnerlr2></div> <!-- Empty state --> <div id="empty-state" class="empty-state" style="display:none;" data-astro-cid-ijnerlr2> <div class="empty-state-icon" data-astro-cid-ijnerlr2>📝</div> <div class="empty-state-title" data-astro-cid-ijnerlr2>No articles yet in this category</div> <p data-astro-cid-ijnerlr2>Be the first trainer to publish in this category. Your article will be featured here and indexed by Google.</p> </div> </div> <!-- Sidebar --> <aside class="blog-sidebar" data-astro-cid-ijnerlr2> <!-- Top contributors --> <div class="sidebar-card" data-astro-cid-ijnerlr2> <div class="sidebar-title" data-astro-cid-ijnerlr2>Top Contributors</div> <div id="top-contributors" data-astro-cid-ijnerlr2></div> </div> <!-- CTA --> <div class="sidebar-cta" data-astro-cid-ijnerlr2> <div class="sidebar-cta-title" data-astro-cid-ijnerlr2>Find your perfect trainer in Dubai</div> <div class="sidebar-cta-sub" data-astro-cid-ijnerlr2>Browse 100+ REPs UAE verified personal trainers. Free to contact.</div> <a href="/find.html" class="sidebar-cta-btn" data-astro-cid-ijnerlr2>Browse Trainers →</a> </div> </aside> </div>  <footer class="blog-footer" data-astro-cid-ijnerlr2> <p data-astro-cid-ijnerlr2>© 2025 TrainedBy.ae · <a href="/landing.html" data-astro-cid-ijnerlr2>For Trainers</a> · <a href="/find.html" data-astro-cid-ijnerlr2>Find a Trainer</a> · <a href="/blog.html" data-astro-cid-ijnerlr2>Blog</a></p> </footer> <script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2.49.4/dist/umd/supabase.min.js" crossorigin="anonymous"></script> <script>(function(){`, `
    ...
    <div class="featured-article" onclick="goToArticle('\${a.slug||a.id}')">
      ...
      <div class="featured-body">
        ...
        <div class="article-meta">
          \${avatarHtml}
          <span class="article-meta-name">\${trainer.name || 'TrainedBy Trainer'}</span>
...
}, "/Users/bobanpepic/trainedby/src/pages/blog.astro", void 0);
const $$file = "/Users/bobanpepic/trainedby/src/pages/blog.astro";
const $$url = "/blog";
