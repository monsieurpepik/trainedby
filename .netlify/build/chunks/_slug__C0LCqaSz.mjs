...
import { h as renderComponent, r as renderTemplate, k as Fragment, u as unescapeHTML } from './ssr-function_BO-eb4Zn.mjs';
...
function BottomNav() {
  return /* @__PURE__ */ jsxs("nav", { id: "tb-bottom-nav", "aria-label": "Main navigation", children: [
    ...
    /* @__PURE__ */ jsxs("a", { href: "/edit", className: "nav-item", children: [
      /* @__PURE__ */ jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: [
  ...
  return /* @__PURE__ */ jsxs("div", { id: "tb-page", children: [
    ...
    /* @__PURE__ */ jsxs("div", { id: "tb-root", children: [
      ...
      loadState === "loaded" && trainer && /* @__PURE__ */ jsxs("div", { id: "profile-mount", children: [
        ...
        /* @__PURE__ */ jsxs("div", { id: "tb-content", children: [
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const SUPABASE_URL$1 = SUPABASE_URL;
  ...
  try {
    const res = await fetch(
      `${SUPABASE_URL$1}/rest/v1/trainers?slug=eq.${encodeURIComponent(slug)}&select=name,specialties,avatar_url,avg_rating,review_count,certifications&limit=1`,
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": pageTitle, "description": pageDesc, "ogImage": "/og/" + slug + ".png", "data-astro-cid-yvbahnfj": true }, { "default": async ($$result2) => renderTemplate(_a || (_a = __template(['  <script type="application/ld+json">', "<\/script>   ", " "])), unescapeHTML(JSON.stringify(jsonLd)), renderComponent($$result2, "TrainerProfile", TrainerProfile, { "client:load": true, "slug": slug, "paymentEnabled": paymentEnabled, "currencySymbol": currencySymbol, "client:component-hydration": "load", "client:component-path": "/Users/bobanpepic/trainedby/src/components/TrainerProfile", "client:component-export": "default", "data-astro-cid-yvbahnfj": true })), "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" })}` })}`;
