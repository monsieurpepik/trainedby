import { g as getMarket, $ as $$Base, r as renderScript } from './Base_glshNjsF.mjs';
import { c as createComponent } from './astro-component_QCe02764.mjs';
import { h as renderComponent, r as renderTemplate, m as maybeRenderHead, j as defineScriptVars } from './ssr-function_qCRG1Hg9.mjs';
  ...
  try {
    ...
    if (res.ok) {
      ...
      if (Array.isArray(data) && data.length > 0 && data[0].is_active !== false) {
        ...
        trainerSpecialty = Array.isArray(data[0].specialty) ? data[0].specialty[0] : data[0].specialty || "Personal Trainer";
