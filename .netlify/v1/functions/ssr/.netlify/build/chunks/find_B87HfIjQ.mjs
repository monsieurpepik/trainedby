...
function getDemoTrainers() {
  ...
  const demos = {
    ...
    uk: [
      ...
      { id:'d5', full_name:'Emily Chen', slug:'emily-chen-uk', title:'Olympic Lifting Coach', city:'Manchester', specialties:['Olympic Lifting','Strength','CrossFit'], certifications:['REPs UK Level 4','UKSCA'], years_experience:8, clients_trained:195, avg_rating:4.8, review_count:33, reps_verified:true, accepting_clients:true, training_modes:['in-person','online'], min_price:70, whatsapp:'+447700900002', avatar_url:'https://images.unsplash.com/photo-1609899464726-209f9a4e9b6c?w=400&q=80' },
