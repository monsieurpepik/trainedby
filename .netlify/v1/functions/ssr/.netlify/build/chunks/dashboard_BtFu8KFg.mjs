...
import { r as renderTemplate, m as maybeRenderHead, h as renderComponent } from './ssr-function_CjOLPKa-.mjs';
...
<\/script> `])), maybeRenderHead(), market.brandName, renderComponent($$result2, "ProfileCompleteness", $$ProfileCompleteness, { "data-astro-cid-3nssi2tu": true }), t(locale, "dash.stats_leads"), t(locale, "dash.stats_views"), t(locale, "dash.stats_wa"), t(locale, "dash.stats_views"), t(locale, "dash.stats_leads"), t(locale, "dash.channel_title"), t(locale, "dash.channel_sub"), t(locale, "dash.channel_dashboard"), t(locale, "dash.channel_whatsapp"), t(locale, "dash.channel_telegram"), t(locale, "dash.ai_title"), t(locale, "dash.channel_dashboard"), t(locale, "nav_edit"), t(locale, "dash.ai_title"), t(locale, "profile_verified_badge").replace("✓ ", ""), t(locale, "pricing.pro_name")) })}`;
