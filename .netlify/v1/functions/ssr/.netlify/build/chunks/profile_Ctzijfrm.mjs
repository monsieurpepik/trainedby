...
function render(t) {
  ...
  if (t.whatsapp) {
    ...
    waBtn.href = \`https://wa.me/\${wn}?text=Hi%20\${encodeURIComponent(t.name)}%2C%20I%20found%20your%20profile%20on%20TrainedBy.ae\`;
    ...
    if (!Array.isArray(reviews) || reviews.length === 0) {
      ...
      document.getElementById('reviewsContent').innerHTML = \`
        <div class="reviews-empty">
          ...
          <div class="reviews-empty-sub">This trainer is new to TrainedBy. Be the first to train with them and leave a review after your session.</div>
        </div>\`;
      return;
    }
...
loadTrainer();
})();</script> `])), maybeRenderHead(), defineScriptVars({ SUPABASE_KEY })) })}`;
